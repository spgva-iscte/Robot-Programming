...
inline double sin(double f) { return sinl(f); }

inline double cos(double f) { return cosl(f); }

inline double asin(double f) { return asinl(f); }

inline double acos(double f) { return acosl(f); }

inline double exp(double f) { return expl(f); }

inline double log(double f) { return logl(f); }

inline double sqrt(double f) { return sqrtl(f); }

inline double atan2(double y, double x) { return atan2l(y, x); }

inline double pow(double x, double y) { return powl(x, y); }

inline float normalizaAngle(const float& angle_) {
    return atan2(sin(angle_),cos(angle_));
}

inline double normalizaAngle(const double& angle_) {
    return atan2(sin(angle_),cos(angle_));
}
...
class DualValue_ {
    public: 
        ...
        inline bool operator>(const DualValue_& v) const { return value > v.value; }
